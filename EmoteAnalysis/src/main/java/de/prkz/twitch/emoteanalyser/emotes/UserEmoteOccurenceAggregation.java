...
// Key: (username, emote)
public class UserEmoteOccurenceAggregation
		extends ProcessWindowFunction<Emote, UserEmoteOccurences, Tuple2<String, String>, TimeWindow> {

	private static final Logger LOG = LoggerFactory.getLogger(UserEmoteOccurenceAggregation.class);

	private transient ValueState<UserEmoteOccurences> occurencesState;
	private transient Connection conn;
	private String jdbcUrl;

	public UserEmoteOccurenceAggregation(String jdbcUrl) {
	...
	public void open(Configuration parameters) throws Exception {
		occurencesState = getRuntimeContext().getState(new ValueStateDescriptor<>(
				"occurences", TypeInformation.of(new TypeHint<UserEmoteOccurences>() {})));
	...
	public void process(Tuple2<String, String> key,
						...
						Collector<UserEmoteOccurences> collector) throws Exception {

		UserEmoteOccurences occurences = occurencesState.value();
		if (occurences == null) {
